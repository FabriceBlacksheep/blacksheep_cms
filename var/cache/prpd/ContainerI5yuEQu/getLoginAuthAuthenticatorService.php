 ...
 */
class getLoginAuthAuthenticatorService extends App_KernelPrpdDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Security\\LoginAuthAuthenticator'])) {
            return $container->privates['App\\Security\\LoginAuthAuthenticator'];
        }

        return $container->privates['App\\Security\\LoginAuthAuthenticator'] = new \App\Security\LoginAuthAuthenticator($a);
    }
}
