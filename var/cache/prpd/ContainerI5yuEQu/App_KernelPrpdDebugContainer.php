 ...
 */
class App_KernelPrpdDebugContainer extends Container
{
    ...
    {
        return $this->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('p4eM13Bmha', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        if (true === $lazyLoad) {
            return $this->services['doctrine.orm.default_entity_manager'] = $this->createProxy('EntityManagerGhostD203151', fn () => \EntityManagerGhostD203151::createLazyGhost($this->getDoctrine_Orm_DefaultEntityManagerService(...)));
        }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ngx4Ymg9ei', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2dwxpvh+9v', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kwPkPlHxJM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IZ30EdV4id', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kjnSCYKiel', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getSerializerService()
    {
        ...
        $h = new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $f, $a)], [0 => $g])));
        ...
        $p = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($n, $j, $f, $a, $o, NULL);

        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($f), 1 => $h, 2 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($i, [], $j), 3 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $j), 4 => $h, 5 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $k, $l, $i, $j), 6 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $m, $i), 7 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($i, true), 8 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true), 9 => new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), 10 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 11 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 12 => new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($b, $c, $k, $m, $l, $d, $f, $j, $n, [], $e), 13 => new \ApiPlatform\Serializer\ItemNormalizer($c, $k, $m, $l, $f, $j, $n, NULL, $b, $e), 14 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 15 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $j), 16 => new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($n, $j, $a, $o, NULL)), 17 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 18 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 19 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 22 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 23 => new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($d, $l, $m, NULL), 'page', 'pagination', $b, $f), $b, $l, ($this->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [], []))), 24 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 25 => new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($p, $m, $d), 26 => $p], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $g, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), 5 => new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    private function getDynamicParameter(string $name)
    {
        $value = match ($name) {
            ...
            'debug.container.dump' => ($this->targetDir.''.'/App_KernelPrpdDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'App_KernelPrpdDebugContainer',
