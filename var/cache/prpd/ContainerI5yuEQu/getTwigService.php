 ...
 */
class getTwigService extends App_KernelPrpdDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addExtension(new \Artgris\Bundle\FileManagerBundle\Twig\FileTypeExtension(($container->privates['Artgris\\Bundle\\FileManagerBundle\\Service\\FileTypeService'] ?? $container->load('getFileTypeServiceService'))));
        $instance->addExtension(new \Artgris\Bundle\FileManagerBundle\Twig\OrderExtension($e));
        $instance->addExtension(new \Twig\Extension\StringLoaderExtension());
        $instance->addExtension(new \Arkounay\Bundle\UxMediaBundle\Service\FileManagerConfigurationService(($container->privates['Artgris\\Bundle\\FileManagerBundle\\Service\\FilemanagerService'] ?? $container->load('getFilemanagerServiceService')), ($container->privates['parameter_bag'] ??= new \Symfony\Component\DependencyInjection\ParameterBag\ContainerBag($container))));
