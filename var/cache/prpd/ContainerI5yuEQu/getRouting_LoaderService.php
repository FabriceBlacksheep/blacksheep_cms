 ...
 */
class getRouting_LoaderService extends App_KernelPrpdDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $e = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), 'prpd');

        $b->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($d, 'prpd'));
        $b->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($d, 'prpd'));
        $b->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($d, 'prpd'));
        $b->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($d, 'prpd'));
        $b->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($d, 'prpd'));
