...
class __TwigTemplate_03dacd9ce5f34ff59d0578724b68ff9d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_category_delete', {'id': category.id}) }}\" onsubmit=\"return confirm('Poursuivre la suppression du contenu ?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ category.id) }}\">
    <button class=\"btn btn-sm btn-danger btnDel\"><i class=\"fa fa-trash\"></i> Supprimer !</button>
</form>
", "category/_delete_form.html.twig", "C:\\laragon2\\www\\BLACKSHEEP_CMS\\app_bs\\templates\\category\\_delete_form.html.twig");
    }
}
