...
/* user/show.html.twig */
class __TwigTemplate_2ab989da4983531c7250f0e94cc87c4b extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 30
        ((twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 30, $this->source); })()), "roles", [], "any", false, false, false, 30)) ? (print (twig_escape_filter($this->env, json_encode(twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 30, $this->source); })()), "roles", [], "any", false, false, false, 30)), "html", null, true))) : (print ("")));
        echo "</td>
            </tr>
            ";
        // line 36
...
";
    ...
    {
        return array (  139 => 39,  134 => 36,  129 => 30,  122 => 26,  119 => 25,  113 => 21,  109 => 19,  104 => 16,  97 => 12,  88 => 5,  78 => 4,  59 => 2,  36 => 1,);
    }
...
<a class=\"btn btn-sm btn-secondary\" href=\"{{ path('app_user_index') }}\">Retour</a>
</div>
{% endblock %}
", "user/show.html.twig", "C:\\laragon2\\www\\BLACKSHEEP_CMS\\app_bs\\templates\\user\\show.html.twig");
    }
}
