...
/* user/new.html.twig */
class __TwigTemplate_4d5300fe193e9630bcf3fabb561396fa extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container bg-white mt-4 p-4\">
    <h4>Créer un utilisateur</h4>
        <a class=\"btn btn-secondary btn-sm\" href=\"{{ path('app_user_index') }}\">Retour</a>
<div class=\"row g-3 align-items-center\">
<div class=\"col-12\">
...
{% endblock %}
", "user/new.html.twig", "C:\\laragon2\\www\\BLACKSHEEP_CMS\\app_bs\\templates\\user\\new.html.twig");
    }
}
