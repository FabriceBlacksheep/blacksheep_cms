...
/* page.html.twig */
class __TwigTemplate_e98dfcf2b77e0cf575da76bb334c97e7 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"fw-bold d-flex align-items-center fs-5\">
                          ...
                          ";
        // line 555
        $context["user"] = twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 555, $this->source); })()), "user", [], "any", false, false, false, 555);
        // line 556
        echo "                          ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 556, $this->source); })()), "prenom", [], "any", false, false, false, 556), "html", null, true);
        echo " ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 556, $this->source); })()), "nom", [], "any", false, false, false, 556), "html", null, true);
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"fw-semibold text-muted text-hover-primary fs-7\">";
        // line 558
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 558, $this->source); })()), "email", [], "any", false, false, false, 558), "html", null, true);
        echo "</a>
\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t<!--end::Username-->
\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t\t<a href=\"/user/";
        // line 569
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 569, $this->source); })()), "user", [], "any", false, false, false, 569), "id", [], "any", false, false, false, 569), "html", null, true);
...
\t\t        <script src=\"/./../assets/js/scripts.bundle.js\"></script>
    ...
    {
        return array (  1211 => 1022,  1197 => 37,  1194 => 35,  1191 => 33,  1187 => 31,  1184 => 30,  1174 => 29,  1157 => 20,  1155 => 19,  1145 => 18,  1126 => 5,  1074 => 1023,  1072 => 1022,  616 => 569,  602 => 558,  594 => 556,  592 => 555,  77 => 42,  75 => 29,  72 => 28,  70 => 18,  58 => 8,  53 => 5,  47 => 1,);
    }
...
\t\t\t\t\t\t\t\t\t\t<!--begin::Menu item-->
\t\t\t\t\t\t\t\t\t\t<div class=\"menu-item px-5\">
\t\t\t\t\t\t\t\t\t\t\t<a href=\"/user/{{app.user.id}}\" class=\"menu-link px-5\">Mon profil</a>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<!--end::Menu item-->
\t\t\t\t\t\t\t\t\t\t<!--begin::Menu item-->
...
", "page.html.twig", "C:\\laragon2\\www\\BLACKSHEEP_CMS\\app_bs\\templates\\page.html.twig");
    }
}
