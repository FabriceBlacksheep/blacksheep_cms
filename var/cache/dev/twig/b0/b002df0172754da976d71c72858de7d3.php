...
class __TwigTemplate_0d2b084239c7e37ce0c32e9674c3c679 extends Template
{
    private $source;
    private $macros = [];
    ...
    <input type=\"hidden\" name=\"_token\" value=\"";
        ...
        echo "\">
    <button class=\"btn btn-danger btnDel\">Supprimer !?</button>
</form>
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Poursuivre la suppression du contenu ?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn btn-danger btnDel\">Supprimer !?</button>
</form>
", "user/_delete_form.html.twig", "C:\\laragon2\\www\\BLACKSHEEP_CMS\\app_bs\\templates\\user\\_delete_form.html.twig");
    }
}
