 ...
 */
class getAdresseAgenceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AdresseAgenceRepository' shared autowired service.
     *
     * @return \App\Repository\AdresseAgenceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AdresseAgenceRepository.php';

        return $container->privates['App\\Repository\\AdresseAgenceRepository'] = new \App\Repository\AdresseAgenceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
