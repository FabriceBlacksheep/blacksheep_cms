...
class __TwigTemplate_31598afa4f89f2feb14ec847f4ba4de0 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h1 style=\"font-weight:300\">";
        // line 26
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["agence"] ?? null), "nom", [], "any", false, false, false, 26), "html", null, true);
        echo "</h1>
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t<!--end::Card title-->
\t\t\t\t\t\t\t\t\t\t\t\t\t<!--begin::Card toolbar-->
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!--begin::Chat-->
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_agence_active", ["id" => twig_get_attribute($this->env, $this->source, ($context["agence"] ?? null), "id", [], "any", false, false, false, 34)]), "html", null, true);
        echo "\" onsubmit=\"return confirm('Etes vous sur de vouloir activer cette agence ?');\">
                                                            <input type=\"hidden\" name=\"_method\" value=\"POST\" />
                                                            <input type=\"hidden\" name=\"_token\" value=\"";
        // line 36
        echo twig_escape_filter($this->env, $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("app_agence_active" . twig_get_attribute($this->env, $this->source, ($context["agence"] ?? null), "id", [], "any", false, false, false, 36))), "html", null, true);
        echo "\">
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
        // line 85
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_agence_edit", ["id" => twig_get_attribute($this->env, $this->source, ($context["agence"] ?? null), "id", [], "any", false, false, false, 85)]), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img src=\"/upload/";
        // line 107
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["agence"] ?? null), "visuel", [], "any", false, false, false, 107), "html", null, true);
        echo "\" alt=\"image\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!--end::Avatar-->
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"text-muted text-hover-primary\">";
        // line 125
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["agence"] ?? null), "email", [], "any", false, false, false, 125), "html", null, true);
        echo "</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!--end::Email-->
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!--begin::Phone-->
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"text-muted text-hover-primary\">";
        // line 138
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["agence"] ?? null), "telephone", [], "any", false, false, false, 138), "html", null, true);
        echo "</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t                ";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["agence"] ?? null), "type", [], "any", false, false, false, 149));
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 219
        echo twig_get_attribute($this->env, $this->source, ($context["agence"] ?? null), "description", [], "any", false, false, false, 219);
        echo "
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"tab-content\">
                                                            ";
        // line 235
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["agence"] ?? null), "horaires", [], "any", false, false, false, 235), "html", null, true);
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!--begin::Day-->
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!--begin::Timeline-->
        ...
        // line 259
        echo "                                                        ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["agence"] ?? null), "adresse", [], "any", false, false, false, 259), "html", null, true);
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!--end::Timeline-->
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!--end:::Tab pane-->
...
";
    ...
    {
        return array (  382 => 270,  368 => 259,  342 => 235,  323 => 219,  302 => 200,  257 => 156,  251 => 155,  245 => 153,  243 => 152,  238 => 151,  235 => 150,  231 => 149,  217 => 138,  201 => 125,  180 => 107,  163 => 92,  159 => 90,  151 => 85,  99 => 36,  93 => 34,  83 => 26,  65 => 11,  58 => 6,  54 => 5,  47 => 3,  36 => 1,);
    }
