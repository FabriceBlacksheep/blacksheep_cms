...
class __TwigTemplate_4ab779c5760823bdb3e0b53b403bb6be extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 3), "errors", [], "any", false, false, false, 3)) > 0)) {
            echo "error";
        }
        echo "\" data-controller=\"arkounay--ux-media--media\" data-arkounay--ux-media--media-path-value=\"";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 3), "value", [], "any", false, false, false, 3), "html", null, true);
        echo "\" data-filemanager-url=\"";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("file_manager_upload", ["conf" => ($context["conf"] ?? null), "extra" => ($context["extra"] ?? null)]), "html", null, true);
        ...
        echo "            </div>
            ...
            ";
        // line 28
        $context["base_path"] = ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 28), "allow_crop", [], "any", false, false, false, 28)) ? ($this->extensions['Arkounay\Bundle\UxMediaBundle\Service\FileManagerConfigurationService']->getWebPath(($context["conf"] ?? null), ($context["extra"] ?? null))) : (1));
        // line 29
        echo "            ";
        ...
        echo "                </div>
                ...
                ";
        // line 82
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 82), "display_file_manager", [], "any", false, false, false, 82)) {
            // line 83
            echo "                    ";
...
";
    ...
    public function block_fields($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 37), "id", [], "any", false, false, false, 37), "html", null, true);
        echo "\" name=\"";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 37), "full_name", [], "any", false, false, false, 37), "html", null, true);
        echo "\" ";
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 37), "required", [], "any", false, false, false, 37)) {
            echo "required=\"required\"";
        }
        echo " value=\"";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 37), "value", [], "any", false, false, false, 37), "html", null, true);
        echo "\" placeholder=\"";
    ...
    public function block_media_buttons($context, array $blocks = [])
    {
        ...
        // line 47
        echo "                        ";
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 47), "allow_crop", [], "any", false, false, false, 47)) {
            // line 48
            ...
            echo "\" data-bs-backdrop=\"static\" data-arkounay--ux-media--media-target=\"cropButton\">
                            ...
                            ";
            // line 55
            $this->loadTemplate("@ArkounayUxMedia/_ux_crop_modal.html.twig", "@ArkounayUxMedia/_ux_media_widget.html.twig", 55)->display(twig_array_merge($context, ["crop_options" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 55), "crop_options", [], "any", false, false, false, 55)]));
            // line 56
            echo "                        ";
        }
        // line 57
        echo "
                        ...
                        ";
        // line 70
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 70), "display_file_manager", [], "any", false, false, false, 70)) {
            // line 71
    ...
    public function block_filemanager_modal($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 84), "id", [], "any", false, false, false, 84), "html", null, true);
    ...
    {
        return array (  300 => 110,  296 => 109,  286 => 100,  277 => 94,  268 => 88,  260 => 84,  256 => 83,  252 => 79,  240 => 71,  238 => 70,  223 => 57,  220 => 56,  218 => 55,  205 => 48,  202 => 47,  198 => 46,  176 => 37,  172 => 36,  156 => 30,  152 => 29,  148 => 2,  130 => 119,  127 => 118,  124 => 109,  122 => 108,  119 => 107,  116 => 106,  113 => 83,  111 => 82,  107 => 80,  105 => 46,  99 => 42,  97 => 36,  94 => 35,  91 => 33,  88 => 29,  86 => 28,  82 => 26,  63 => 9,  61 => 8,  46 => 3,  44 => 2,  42 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@ArkounayUxMedia/_ux_media_widget.html.twig", "C:\\laragon2\\www\\BLACKSHEEP_CMS\\app_bs\\vendor\\arkounay\\ux-media\\templates\\_ux_media_widget.html.twig");
    }
}
